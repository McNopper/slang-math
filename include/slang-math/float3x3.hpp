#ifndef SLANG_MATH_FLOAT3X3_HPP
#define SLANG_MATH_FLOAT3X3_HPP
...
struct float3x3 {
    ...
    constexpr float3x3(const float3& r0, const float3& r1, const float3& r2) noexcept : rows{r0, r1, r2} {}

    /// Diagonal constructor: `float3x3(1.f)` = identity.
    constexpr explicit float3x3(float s) noexcept : rows{{s, 0, 0}, {0, s, 0}, {0, 0, s}} {}

    [[nodiscard]] static constexpr float3x3 identity() noexcept { return {{1, 0, 0}, {0, 1, 0}, {0, 0, 1}}; }
