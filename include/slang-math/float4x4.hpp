...
struct float4x4 {
    ...
    constexpr float4x4(const float4& r0, const float4& r1, const float4& r2, const float4& r3) noexcept
        : rows{r0, r1, r2, r3} {}

    /// Diagonal constructor: `float4x4(1.f)` = identity.
    constexpr explicit float4x4(float s) noexcept : rows{{s, 0, 0, 0}, {0, s, 0, 0}, {0, 0, s, 0}, {0, 0, 0, s}} {}
